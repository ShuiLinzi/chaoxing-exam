...
@TableName("reading_parent_question")
@ApiModel(value="ReadingParentQuestion对象", description="阅读理解题干题库")
public class ReadingParentQuestion implements Serializable {
